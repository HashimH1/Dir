            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="contact-page__form">
                        <form action="{{ route('apply.store') }}" method="POST" class="comment-one__form contact-form-validated" novalidate="novalidate">
                           @csrf
                            <div class="row">
                                <div class="col-xl-6">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <input type="submit" class="thm-btn comment-form__btn" value="send a message">
                                </div>
                            </div>
                        </form>
                    </div>
