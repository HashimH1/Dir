          ...
          <div style="padding: 45px" class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                ...
                <form role="form" action="{{ route('admin.project.update') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3 ">
                                    ...
                                    <input value="{{ $project->title }}" type="name" name="title" class="form-control">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group input-group-outline my-3 ">
                            ...
                            <input value="{{ $project->client }}"  type="name" name="client" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group input-group-outline my-3 ">
                            ...
                            <input value="{{ $project->date }}"   type="date" name="date" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group input-group-outline my-3 ">
                            ...
                            <input value="{{ $project->facebook }}"  type="name" name="facebook" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group input-group-outline my-3 ">
                            ...
                            <input value="{{ $project->twitter }}"  type="name" name="twitter" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group input-group-outline my-3 ">
                            ...
                            <input   value="{{ $project->pinterest }}"  type="name" name="pinterest" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group input-group-outline my-3 ">
                            ...
                            <input  value="{{ $project->instagram }}" type="name" name="instagram" class="form-control">
                        </div>
                    </div>
                </div>
