          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">ALL comments </h6>
              </div>
            </div>
                ...
                @foreach ($comments as $comment )
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                          ...
                          <td style="text-align: center">
                            <p class="text-xs font-weight-bold mb-0">{{ $comment->new->name }} </p>
                          ...
                          <td style="text-align: center">
                            <p class="text-xs font-weight-bold mb-0">{{ $comment->message }} </p>
                      ...
                      <td class="align-middle text-center">
                        ...
                        <a style="margin-left: 10px" onclick="return confirm('Are you sure you want to delete this comment?');" href="{{ route('comment.delete',$comment->id) }}" class="badge badge-sm bg-gradient-secondary">delete</a>
